            ...
            switch (dados[0]){
                case "Criar":
                    for(Licitador l: licitadores){
                        if(l.getUsername().equals(dados[1])){
                ...
                case "Licitar":
                    for(Licitador l: licitadores){
                        if(!(l.getUsername().equals(dados[2]))){
                            if(l.getLeiloes().contains(Integer.parseInt(dados[1]))){
